...
class Process
{
     ...
     *            it can be a Runnable object, callback function or null
     * @param null $name
     *            process name,you can manager the process by it's name.
     */
     ...
     *
     * @param bool|true $block
     *            if block the process
     * @param int $sleep
     *            default 0.1s check sub process status
